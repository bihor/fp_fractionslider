...
namespace Fixpunkt\FpFractionslider\Updates;
...
class SwitchableControllerActionsPluginUpdater implements UpgradeWizardInterface
{
    private const MIGRATION_SETTINGS = [
        [
            'sourceListType' => 'fpfractionslider_pi1',
            'switchableControllerActions' => 'Slide->fractionslider;Slide->show',
            'targetListType' => 'fpfractionslider_fractionslider',
        ],
        [
            'sourceListType' => 'fpfractionslider_pi1',
            'switchableControllerActions' => 'Slide->sliderpro;Slide->show',
            'targetListType' => 'fpfractionslider_sliderpro',
        ],
        [
            'sourceListType' => 'fpfractionslider_pi1',
            'switchableControllerActions' => 'Slide->sliderrevolution;Slide->show',
            'targetListType' => 'fpfractionslider_sliderrevolution',
        ],
        [
            'sourceListType' => 'fpfractionslider_pi1',
            'switchableControllerActions' => 'Slide->list;Slide->show',
            'targetListType' => 'fpfractionslider_list',
        ],
        [
            'sourceListType' => 'fpfractionslider_pi1',
            'switchableControllerActions' => 'Slide->show',
            'targetListType' => 'fpfractionslider_show',
        ]
    ];
    ...
    {
        return 'switchableControllerActionsPluginUpdaterFpFrac';
    }

    public function getTitle(): string
    {
        return 'Migrates plugin and settings of existing Fractionslider plugins using switchableControllerActions';
    }

    public function getDescription(): string
    {
        $description = 'The old Fractionslider plugin using switchableControllerActions has been split into separate plugins. ';
